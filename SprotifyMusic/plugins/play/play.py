...
async def play_commnd(
    ...
    if audio_telegram:
        if audio_telegram.file_size > 10737418240:
...
@app.on_callback_query(filters.regex("SprotifymousAdmin") & ~BANNED_USERS)
async def Sprotifymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
